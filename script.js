...
const dashboardData = {
  ...
  batch25: {
    ...
    nationalities: [
      ...
      { name: "سوريا", count: 36, high: 98.032, low: 80.000, branches: ["فرع الخرج (الرئيسي)", "فرع الأفلاج", "فرع حوطة بني تميم", "فرع وادي الدواسر"] },
      { name: "السودان", count: 21, high: 99.180, low: 84.180, branches: ["فرع الخرج (الرئيسي)", "فرع الدلم", "فرع حوطة بني تميم", "فرع وادي الدواسر"] },
      { name: "فلسطين", count: 15, high: 98.500, low: 80.990, branches: ["فرع الخرج (الرئيسي)", "فرع حوطة بني تميم", "فرع وادي الدواسر"] },
      ...
      { name: "الأردن", count: 10, high: 99.310, low: 94.000, branches: ["فرع الخرج (الرئيسي)"] },
